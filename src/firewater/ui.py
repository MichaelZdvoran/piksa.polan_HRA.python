...
class HUD:
    ...
    def draw_menu(self, screen):
        ...
        water_text = self.font_small.render("đźŚŠ Guide Water to the goal!", True, COLOR_WATER)
        fire_text = self.font_small.render("đź”Ą Guide Fire to the goal!", True, COLOR_FIRE)
